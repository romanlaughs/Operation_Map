...
var a = i(o(function(e2, i2) {
  ...
  var s2 = "browser-tabs-lock-key", c2 = {
    key: function(e3) {
      ...
      return void 0 === i3 && (i3 = 5e3), o2(this, void 0, void 0, function() {
        ...
        return a2(this, function(a3) {
          switch (a3.label) {
            ...
            case 3:
              return a3.sent(), l3.setItemSync(r3, JSON.stringify({
                id: this.id,
                iat: o3,
                timeoutKey: h2,
...
var v = (t2) => {
  ...
  return new URLSearchParams(((e2) => Object.keys(e2).filter((t3) => void 0 !== e2[t3]).reduce((t3, i3) => Object.assign(Object.assign({}, t3), {
    [i3]: e2[i3]
  }), {}))(Object.assign({
    client_id: i2
  }, o2))).toString();
...
var S = (e2, t2, i2, o2, n2, a2, r2) => __async(void 0, null, function* () {
  return s2 = {
    ...
    fetchOptions: o2,
    useFormData: r2
  }, c2 = a2, new Promise(function(e3, t3) {
...
function T(t2, i2) {
  return __async(this, null, function* () {
    var {
      ...
      auth0Client: c2,
      useFormData: u2
    } = t2, l2 = e(t2, ["baseUrl", "timeout", "audience", "scope", "auth0Client", "useFormData"]);
    ...
    return yield function(t3, i3, o3, n3, a3, r3, s2) {
      return __async(this, null, function* () {
        ...
        const l3 = c3.json, {
          error: h3,
          error_description: p2
        } = l3, g2 = e(l3, ["error", "error_description"]), {
          ok: w2
        } = c3;
        if (!w2) {
    ...
    }(`${o2}/oauth/token`, n2, a2 || "default", r2, {
      method: "POST",
      body: h2,
      headers: {
...
var x = class {
  ...
  setIdToken(e2, t2, i2) {
    return __async(this, null, function* () {
      ...
      yield this.cache.set(n2, {
        id_token: t2,
        decodedToken: i2
      }), yield null === (o2 = this.keyManifest) || void 0 === o2 ? void 0 : o2.add(n2);
    });
  }
  getIdToken(e2) {
    return __async(this, null, function* () {
  ...
  get(e2, t2 = 0) {
    return __async(this, null, function* () {
      ...
      return o2.expiresAt - t2 < a2 ? o2.body.refresh_token ? (o2.body = {
        refresh_token: o2.body.refresh_token
      }, yield this.cache.set(e2.toKey(), o2), o2.body) : (yield this.cache.remove(e2.toKey()), void (yield null === (i2 = this.keyManifest) || void 0 === i2 ? void 0 : i2.remove(e2.toKey()))) : o2.body;
    });
  }
  set(e2) {
    return __async(this, null, function* () {
      ...
      }), o2 = yield this.wrapCacheEntry(e2);
  ...
  wrapCacheEntry(e2) {
    return __async(this, null, function* () {
      ...
      return {
        body: e2,
        expiresAt: Math.floor(t2 / 1e3) + e2.expires_in
      };
    });
  }
  getCacheKeys() {
...
var X = {
  ...
  save(e2, t2, i2) {
    ...
    "https:" === window.location.protocol && (o2 = {
      secure: true,
      sameSite: "none"
    }), (null == i2 ? void 0 : i2.daysUntilExpire) && (o2.expires = i2.daysUntilExpire), (null == i2 ? void 0 : i2.cookieDomain) && (o2.domain = i2.cookieDomain), L(e2, JSON.stringify(t2), o2);
  },
  remove(e2, t2) {
    let i2 = {};
...
var N = {
  ...
  save(e2, t2, i2) {
    ...
    "https:" === window.location.protocol && (o2 = {
      secure: true
    }), (null == i2 ? void 0 : i2.daysUntilExpire) && (o2.expires = i2.daysUntilExpire), (null == i2 ? void 0 : i2.cookieDomain) && (o2.domain = i2.cookieDomain), L(`_legacy_${e2}`, JSON.stringify(t2), o2), X.save(e2, t2, i2);
  },
  remove(e2, t2) {
    let i2 = {};
...
function F(e2, t2, i2) {
  var o2 = void 0 === t2 ? null : t2, n2 = function(e3, t3) {
    ...
    return i3;
  }(e2, void 0 !== i2 && i2), a2 = n2.indexOf("\n", 10) + 1, r2 = n2.substring(a2) + (o2 ? "//# sourceMappingURL=" + o2 : ""), s2 = new Blob([r2], {
...
var B = class {
  ...
  add(e2) {
    return __async(this, null, function* () {
      ...
      i2.add(e2), yield this.cache.set(this.manifestKey, {
        keys: [...i2]
      });
    });
  }
  remove(e2) {
    return __async(this, null, function* () {
      ...
      if (t2) {
        ...
        return i2.delete(e2), i2.size > 0 ? yield this.cache.set(this.manifestKey, {
          keys: [...i2]
...
var te = class {
  constructor(e2) {
    ...
    if (this.userCache = new P().enclosedCache, this.defaultOptions = {
      ...
      useFormData: true
    }, this._releaseLockOnPageHide = () => __async(this, null, function* () {
      yield ee.releaseLock("auth0.lock.getTokenSilently"), window.removeEventListener("pagehide", this._releaseLockOnPageHide);
    }), this.options = Object.assign(Object.assign(Object.assign({}, this.defaultOptions), e2), {
      authorizationParams: Object.assign(Object.assign({}, this.defaultOptions.authorizationParams), e2.authorizationParams)
  ...
  _verifyIdToken(e2, t2, i2) {
    return __async(this, null, function* () {
      ...
      return E({
        ...
        max_age: (n2 = this.options.authorizationParams.max_age, "string" != typeof n2 ? n2 : parseInt(n2, 10) || void 0),
        now: o2
      });
      var n2;
    });
  ...
  _processOrgHint(e2) {
    e2 ? this.cookieStorage.save(this.orgHintCookieName, e2, {
  ...
  _prepareAuthorizeUrl(e2, t2, i2) {
    return __async(this, null, function* () {
      const o2 = k(y()), n2 = k(y()), a2 = y(), r2 = ((e3) => {
        ...
        return yield t3;
      }))(a2)), s2 = ((e3, t3, i3, o3, n3, a3, r3, s3) => Object.assign(Object.assign(Object.assign({
        client_id: e3.clientId
      }, e3.authorizationParams), i3), {
        scope: j(t3, i3.scope),
        response_type: "code",
      ...
      }))(this.options, this.scope, e2, o2, n2, r2, e2.redirect_uri || this.options.authorizationParams.redirect_uri || i2, null == t2 ? void 0 : t2.response_mode), c2 = this._authorizeUrl(s2);
      return {
        nonce: n2,
        code_verifier: a2,
        scope: s2.scope,
  ...
  loginWithPopup(e2, t2) {
    return __async(this, null, function* () {
      ...
      const o2 = yield this._prepareAuthorizeUrl(e2.authorizationParams || {}, {
  ...
  loginWithRedirect() {
    return __async(this, arguments, function* (t2 = {}) {
      ...
      const o2 = Q(t2), {
        ...
        fragment: a2,
        appState: r2
      } = o2, s2 = e(o2, ["openUrl", "fragment", "appState"]), c2 = (null === (i2 = s2.authorizationParams) || void 0 === i2 ? void 0 : i2.organization) || this.options.authorizationParams.organization, d2 = yield this._prepareAuthorizeUrl(s2.authorizationParams || {}), {
        url: u2
      } = d2, l2 = e(d2, ["url"]);
      this.transactionManager.create(Object.assign(Object.assign(Object.assign({}, l2), {
        appState: r2
      }), c2 && {
        organization: c2
      }));
  ...
  getTokenSilently() {
    return __async(this, arguments, function* (e2 = {}) {
      var t2;
      const i2 = Object.assign(Object.assign({
        cacheMode: "on"
      }, e2), {
        authorizationParams: Object.assign(Object.assign(Object.assign({}, this.options.authorizationParams), e2.authorizationParams), {
          scope: j(this.scope, null === (t2 = e2.authorizationParams) || void 0 === t2 ? void 0 : t2.scope)
        })
      }), o2 = yield ((e3, t3) => {
        let i3 = A[t3];
  ...
  _getTokenSilently(t2) {
    return __async(this, null, function* () {
      ...
      if ("off" !== i2) {
        const e2 = yield this._getEntryFromCache({
      ...
      if ("cache-only" !== i2) {
        if (!(yield ((e2, t3 = 3) => __async(this, null, function* () {
          for (let i3 = 0; i3 < t3; i3++) if (yield e2()) return true;
          return false;
        ...
        try {
          ...
          const e2 = this.options.useRefreshTokens ? yield this._getTokenUsingRefreshToken(o2) : yield this._getTokenFromIFrame(o2), {
            id_token: t3,
            access_token: n2,
            oauthTokenScope: a2,
            expires_in: r2
  ...
  getTokenWithPopup() {
    return __async(this, arguments, function* (e2 = {}, t2 = {}) {
      ...
      const o2 = Object.assign(Object.assign({}, e2), {
        authorizationParams: Object.assign(Object.assign(Object.assign({}, this.options.authorizationParams), e2.authorizationParams), {
          scope: j(this.scope, null === (i2 = e2.authorizationParams) || void 0 === i2 ? void 0 : i2.scope)
        })
      });
      t2 = Object.assign(Object.assign({}, r), t2), yield this.loginWithPopup(o2, t2);
      return (yield this.cacheManager.get(new C({
        scope: o2.authorizationParams.scope,
        audience: o2.authorizationParams.audience || "default",
        clientId: this.options.clientId
      }))).access_token;
  ...
  _buildLogoutUrl(t2) {
    ...
    const i2 = t2.logoutParams || {}, {
      federated: o2
    } = i2, n2 = e(i2, ["federated"]), a2 = o2 ? "&federated" : "";
  ...
  logout() {
    return __async(this, arguments, function* (t2 = {}) {
      ...
      null === t2.clientId ? yield this.cacheManager.clear() : yield this.cacheManager.clear(t2.clientId || this.options.clientId), this.cookieStorage.remove(this.orgHintCookieName, {
        cookieDomain: this.options.cookieDomain
  ...
  _getTokenFromIFrame(e2) {
    return __async(this, null, function* () {
      ...
      const {
        ...
        scope: c2,
        audience: u2
      } = yield this._prepareAuthorizeUrl(t2, {
        response_mode: "web_message"
      }, window.location.origin);
      try {
        ...
        const p2 = yield this._requestToken(Object.assign(Object.assign({}, e2.authorizationParams), {
          code_verifier: r2,
          code: h2.code,
          grant_type: "authorization_code",
          redirect_uri: s2,
        ...
        throw "login_required" === e3.error && this.logout({
          openUrl: false
        }), e3;
      }
    });
  ...
  _getTokenUsingRefreshToken(e2) {
    return __async(this, null, function* () {
      const t2 = yield this.cacheManager.get(new C({
      ...
      try {
        const n2 = yield this._requestToken(Object.assign(Object.assign(Object.assign({}, e2.authorizationParams), {
  ...
  _saveEntryInCache(t2) {
    return __async(this, null, function* () {
      const {
        id_token: i2,
        decodedToken: o2
      } = t2, n2 = e(t2, ["id_token", "decodedToken"]);
      this.userCache.set("@@user@@", {
        id_token: i2,
        decodedToken: o2
      }), yield this.cacheManager.setIdToken(this.options.clientId, t2.id_token, t2.decodedToken), yield this.cacheManager.set(n2);
    });
  }
  _getIdTokenFromCache() {
    return __async(this, null, function* () {
      const e2 = this.options.authorizationParams.audience || "default", t2 = yield this.cacheManager.getIdToken(new C({
        clientId: this.options.clientId,
        audience: e2,
        scope: this.scope
  ...
  _getEntryFromCache(_0) {
    return __async(this, arguments, function* ({
      ...
      const o2 = yield this.cacheManager.get(new C({
        scope: e2,
        audience: t2,
        clientId: i2
      }), 60);
      if (o2 && o2.access_token) {
        const {
          ...
          oauthTokenScope: t3,
          expires_in: i3
        } = o2, n2 = yield this._getIdTokenFromCache();
        return n2 && Object.assign(Object.assign({
          id_token: n2.id_token,
          access_token: e3
        }, t3 ? {
          scope: t3
        } : null), {
  ...
  _requestToken(e2, t2) {
    return __async(this, null, function* () {
      const {
        nonceIn: i2,
        organization: o2
      } = t2 || {}, n2 = yield T(Object.assign({
        baseUrl: this.domainUrl,
        client_id: this.options.clientId,
        auth0Client: this.options.auth0Client,
        useFormData: this.options.useFormData,
        timeout: this.httpTimeoutMs
      }, e2), this.worker), a2 = yield this._verifyIdToken(n2.id_token, i2, o2);
      return yield this._saveEntryInCache(Object.assign(Object.assign(Object.assign(Object.assign({}, n2), {
        decodedToken: a2,
        scope: e2.scope,
        ...
        daysUntilExpire: this.sessionCheckExpiryDays,
        cookieDomain: this.options.cookieDomain
      }), this._processOrgHint(o2 || a2.claims.org_id), Object.assign(Object.assign({}, n2), {
        decodedToken: a2
      });
    });
  }
...
// node_modules/@auth0/auth0-angular/fesm2020/auth0-auth0-angular.mjs
var useragent = {
...
AuthClientConfig.ɵfac = function AuthClientConfig_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || AuthClientConfig)(ɵɵinject(AuthConfigService, 8));
};
...
AbstractNavigator.ɵfac = function AbstractNavigator_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || AbstractNavigator)(ɵɵinject(Location), ɵɵinject(Injector));
};
...
AuthState.ɵfac = function AuthState_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || AuthState)(ɵɵinject(Auth0ClientService));
};
...
AuthService.ɵfac = function AuthService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || AuthService)(ɵɵinject(Auth0ClientService), ɵɵinject(AuthClientConfig), ɵɵinject(AbstractNavigator), ɵɵinject(AuthState));
};
...
AuthGuard.ɵfac = function AuthGuard_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || AuthGuard)(ɵɵinject(AuthService));
};
...
AuthHttpInterceptor.ɵfac = function AuthHttpInterceptor_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || AuthHttpInterceptor)(ɵɵinject(AuthClientConfig), ɵɵinject(Auth0ClientService), ɵɵinject(AuthState), ɵɵinject(AuthService));
};
