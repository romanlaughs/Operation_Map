...
export const hoverbleData = [
    {
        id: 1,
        status: 'No Signal',
        class: 'success',
        icon: 'alert-triangle',
        signal: 'Astrid: NE Shared managed',
        security: 'Medium',
        stage: 'riaged',
        schedule: '	0.33',
    ...
    },
    {
        ...
        class: 'primary',
        icon: 'alert-circle',
        signal: 'Phoenix: prod shared lyra-lists',
        security: 'Minor',
        stage: 'No Triaged',
        schedule: '	3.12',
