...
export declare class BarRating implements OnInit, OnChanges, ControlValueAccessor, Validator {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<BarRating, "bar-rating", never, { "rate": { "alias": "rate"; "required": false; }; "max": { "alias": "max"; "required": false; }; "readOnly": { "alias": "readOnly"; "required": false; }; "theme": { "alias": "theme"; "required": false; }; "showText": { "alias": "showText"; "required": false; }; "titles": { "alias": "titles"; "required": false; }; "required": { "alias": "required"; "required": false; }; }, { "hover": "hover"; "leave": "leave"; "rateChange": "rateChange"; "barClick": "barClick"; }, ["customActiveRating", "customInActiveRating", "customFractionRating"], never, false, never>;
}
export {};
