...
export class AttachToOverlayService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.0.1", ngImport: i0, type: AttachToOverlayService, deps: [{ token: i0.Injector }, { token: i1.ModalGalleryService }], target: i0.ɵɵFactoryTarget.Injectable }); }
