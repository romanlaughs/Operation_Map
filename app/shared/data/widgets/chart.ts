...
export const widgetChart: ChartOptions | any = {
  chart: {
    toolbar: {
      show: false,
    },
...
export const widgetChart2: ChartOptions | any = {
  chart: {
    toolbar: {
      show: false,
    },
...
export const widgetChart3: ChartOptions | any = {
  chart: {
    toolbar: {
      show: false,
    },
...
export const monthlyHistoryData: ChartOptions | any = {
  series: [
    {
      name: 'Profit',
  ...
  colors: [secondary_color, '#3eb95f', primary_color],
  fill: {
    type: 'gradient',
    gradient: {
      shade: 'light',
...
export const SkillStatus: ChartOptions | any = {
  ...
  colors: [secondary_color, primary_color, '#3eb95f'],
  responsive: [
    {
      breakpoint: 767,
      options: {
...
export const Progress2: ChartOptions | any = {
  chart: {
    height: 70,
    type: 'bar',
    stacked: true,
...
export const Progress3: ChartOptions | any = {
  chart: {
    height: 70,
    type: 'bar',
    stacked: true,
...
export const Progress4: ChartOptions | any = {
  chart: {
    height: 70,
    type: 'bar',
    stacked: true,
...
export const Progress5: ChartOptions | any = {
  chart: {
    height: 70,
    type: 'bar',
    stacked: true,
...
export const LiveProducts: ChartOptions | any = {
  chart: {
    height: 320,
    type: 'area',
    toolbar: {
...
export const Turnover: ChartOptions | any = {
  chart: {
    toolbar: {
      show: false,
    },
...
export const CryptocurrencyPrices: ChartOptions | any = {
  chart: {
    toolbar: {
      show: false,
    },
...
export const CryptoAnnotations: ChartOptions | any = {
  series: [
    {
...
export const StockMarket: ChartOptions | any = {
  series: [
    {
      name: 'line',
      type: 'line',
  ...
  plotOptions: {
    candlestick: {
      colors: {
        upward: secondary_color,
        downward: primary_color,
      },
    },
  },
  legend: {
...
export const orderstatus: ChartOptions | any = {
  chart: {
    height: 350,
    type: 'line',
    stacked: true,
...
export const Finance: ChartOptions | any = {
  chart: {
    height: 350,
    type: 'line',
    toolbar: {
...
export const uses: ChartOptions | any = {
  chart: {
    toolbar: {
      show: false,
    },
  ...
  colors: [primary_color, secondary_color, '#3eb95f', primary_color],
  title: {
